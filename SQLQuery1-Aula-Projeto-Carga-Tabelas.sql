...
INSERT INTO CLIENTES VALUES
	(1,'CARLOS JACOB HOUSTON','CARLOS','RUA 1','375','SANTA HELENA','4203709','13290000','123456789','F',GETDATE(),1),
	(1,'PEDRO LARSON OHIO','PEDRO','RUA 2','235','SANTA CLARA','4119608','13290987','123456989','F',GETDATE(),2),
	(2,'BIKES ON LTDA','BIKES ON','RUA 14','279','MONTANHA','5300108','13293245','343456987','F',GETDATE(),3),
...
INSERT INTO FORNECEDORES VALUES
	...
	(2,'TRIAL BIKES ME','TRAIL BIKES','RUA 70','345','ESFERA','5300108','13293245','343456987','J',GETDATE(),3)

--SELECT * FROM FORNECEDORES

--CARGA TABELA TIPO DE MATERIAL

INSERT INTO TIPO_MAT VALUES (1,1,'MATERIA PRIMA'),(1,2,'PRODUTO ACABADO'),
							(1,3,'EMBALAGEM'),(1,4,'CONSUMO')
INSERT INTO TIPO_MAT VALUES (2,1,'MATERIA PRIMA'),(2,2,'PRODUTO ACABADO'),
...
INSERT INTO MATERIAL VALUES
	...
	(1,4,'KIT TRANSMISSAO','500','1','1'), --FREIO + MARCHA + PE DE VELA + TROCADORES + K-7
	(1,5,'ARO 29','70','1','1'),
	(1,6,'PNEU 29','100','1','2'),
...
--TRIGGER PARA NUMERAÇÃO DE MATRICULAS
...
INSERT INTO FUNCIONARIO VALUES
 (1,0,'9001','JAMES LABRIE','123456','123567990','RUA 1','2','SANTA CLAUS','3525904','2017-01-03','','1980-12-25','','1')
INSERT INTO FUNCIONARIO VALUES
 (1,0,'9002','JOHN LARAVEL','1234568','123567889','RUA 2','3','SANTA CLAUS','3525904','2017-02-10','','1980-12-25','','4')
 INSERT INTO FUNCIONARIO VALUES
 (1,0,'9003','PETER DONESK','3434568','123564578','RUA 3','4','SANTA CLAUS','3525904','2017-02-09','','1980-12-25','','6')
 INSERT INTO FUNCIONARIO VALUES
 (1,0,'9004','LARA POTTER','4434509','1235786867','RUA 4','5','SANTA CLAUS','3525904','2017-03-07','','1980-12-25','','7')
 INSERT INTO FUNCIONARIO VALUES
 ...
 INSERT INTO FUNCIONARIO VALUES
 (1,0,'9007','TIAGO FELDER','9834568','147034889','RUA 7','8','SANTA CLAUS','3525904','2017-04-20','','1980-12-25','','2')
 INSERT INTO FUNCIONARIO VALUES
...
--CARGA CFOP CODIGO DE OPERAÇÕES
--DELETE FROM CFOP
...
-- TRIGGER PARA NUMERAÇÃO DE PEDIDO DE VENDA
